...
export const mockTestimonials = [
  {
    ...
    content:
      "Harrison made our wedding absolutely magical. Her performance during our ceremony brought tears to everyone's eyes. The way she played 'Canon in D' as I walked down the aisle was everything I dreamed of and more. She was incredibly professional, easy to work with, and her music created the perfect atmosphere throughout our cocktail hour. We couldn't have asked for a more talented musician.",
    rating: 5,
    isApproved: true,
    isFeatured: true,
  },
  {
    ...
    content:
      "We hired Harrison for our annual company gala and she exceeded all expectations. Her elegant performance set the perfect tone for our black-tie event. Our guests were thoroughly impressed with both her talent and professionalism. We've already booked her for next year's event!",
    rating: 5,
    isApproved: true,
    isFeatured: true,
  },
  {
    ...
    content:
      "Harrison performed at our 25th wedding anniversary celebration. She learned our wedding song and played it perfectly - such a touching moment for us. Her repertoire was diverse and she kept our guests entertained all evening. A true professional with extraordinary talent.",
    rating: 5,
    isApproved: true,
    isFeatured: true,
  },
  {
    ...
    content:
      "From our first consultation to the last note at our reception, Harrison was amazing. She provided excellent suggestions for our ceremony music and seamlessly transitioned between different parts of our wedding day. Her violin added such an elegant touch to our vineyard wedding.",
    rating: 5,
    isApproved: true,
    isFeatured: false,
  },
  {
    ...
    content:
      "Harrison performed at our product launch event and created exactly the sophisticated ambiance we were looking for. She was flexible with timing as our schedule shifted, and her music impressed all of our VIP guests. Highly recommend for corporate events!",
    rating: 5,
    isApproved: true,
    isFeatured: false,
  },
